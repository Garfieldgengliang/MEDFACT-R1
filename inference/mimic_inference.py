...
import json
MODEL_PATH = "/root/autodl-tmp/QwenVL-3B-mimic"
...
# )
logging.basicConfig(filename='/root/autodl-tmp/R1-V-inference/mimic_test_inference_0412.log', level=logging.INFO)

logging.log(logging.INFO, 'Start of inferencing MIMIC test dataset')
...
# max_pixels = 501760
max_pixels = 2500000
processor = AutoProcessor.from_pretrained("/root/autodl-tmp/QwenVL-3B-mimic", min_pixels=min_pixels, max_pixels=max_pixels)

with open('grpo_mimic_test_data_20250409.json', 'r') as file:
...
with open("/root/autodl-tmp/R1-V-inference/grpo_mimic_test_answer_20250412.json", "w", encoding="utf-8") as f:
