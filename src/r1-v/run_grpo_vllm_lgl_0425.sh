...
export LOG_PATH="./vllm_run_0425.txt"

QWEN_PATH="/root/autodl-tmp/Qwen2-5-VL-3B-Instruct"
MIMIC_DATASET="/root/autodl-tmp/mimic_grpo_0422"
OUTPUT_DIR="OUTPUT_DIR_mimic_fake_label_no_kwreward_0425"
RUN_NAME="MIMIC_QWEN25_3B_GRPO_20250425"
